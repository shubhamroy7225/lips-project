...
$(document).ready(function () {
  ...
  // Close popup
  $("#trigger_collection").click(function () {
    $('#trigger_collection_popup').show();
  });
  $('.popupCloseButton').click(function () {
    $('#trigger_collection_popup').hide();
  });
  // ChatBox popup
  ...
  // add popup
  $("#trigger_add_tags").click(function () {
  ...
  // Lips tag popup
  $("#trigger_lips_tag").click(function () {
    $('#trigger_lips_tag_popup').show();
  });
  $('.popupCloseButton').click(function () {
    $('#trigger_lips_tag_popup').hide();
  });
  // Questions tag popup
  $("#trigger_questions").click(function () {
    $('#trigger_questions_popup').show();
  });
  $('.popupCloseButton').click(function () {
    $('#trigger_questions_popup').hide();
  });
  // tooltips popup
  ...
  $(".icn_hover_chng").click(function () {
    $(this).toggleClass('active');
  });
  // main feed side menu
  $("#trigger_main_feed").click(function () {
    $('#lps_widgets').toggle();
  });
  $(".trigger_main_feed1").click(function () {
    $('.lps_widgets_cont1').toggle();
  });
  $("#trigger_followers_block").click(function () {
    $('#followers_block').toggle();
  });
  // Want post popup
  $("#trigger_postW").click(function () {
    $('#trigger_Wpost_popup').show();
  });
  $('.popupCloseButton').click(function () {
    $('#trigger_Wpost_popup').hide();
  });
  // Liked no account popup
  $("#trigger_likedNoA").click(function () {
    $('#trigger_liked_no_A_popup').show();
  });
  $('.popupCloseButton').click(function () {
    $('#trigger_liked_no_A_popup').hide();
  });
  // My Profile no account popup
  $("#trigger_myProfile_noA").click(function () {
    $('#trigger_myProfile_noA_popup').show();
  });
  $('.popupCloseButton').click(function () {
    $('#trigger_myProfile_noA_popup').hide();
  });
